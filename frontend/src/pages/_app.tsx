      ...
      <header className="sticky top-0 z-50 border-b border-zinc-800/80 bg-zinc-950/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-1.5 sm:gap-2">
            <Link
              to="/"
              className="text-xs sm:text-sm text-zinc-300 hover:text-white px-2.5 py-1.5 rounded-lg hover:bg-zinc-900 transition-colors flex items-center gap-1.5"
            >
            ...
            <Link
              to="/admin"
              className="text-xs sm:text-sm text-zinc-400 hover:text-zinc-200 px-2.5 py-1.5 rounded-lg hover:bg-zinc-900 transition-colors flex items-center gap-1.5"
            >
            ...
            <Link
              to="/check"
              className="text-xs sm:text-sm font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-3 sm:px-4 py-2 rounded-xl shadow-md shadow-blue-600/20 hover:shadow-blue-600/30 active:scale-95 transition-all flex items-center gap-1.5"
            >
