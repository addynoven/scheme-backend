...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-4.2rem)] w-full -m-4 sm:-m-6 md:-m-10 overflow-hidden bg-[#09090b] text-zinc-100 relative">
      ...
      {/* Left Sidebar (ChatGPT / Claude Style Collapsible History) */}
      <aside
        className={`${
          ...
          <div className="flex items-center gap-2.5 p-2 rounded-xl bg-zinc-900/80 border border-zinc-800">
            ...
            <div className="truncate text-left flex-1 min-w-0">
              ...
              <p className="text-[10px] text-emerald-400 font-medium truncate">
                {citizen?.profile ? `${citizen.profile.state} · ${citizen.profile.occupation}` : 'Profile Verified'}
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative bg-[#09090b]">
        ...
        <div className="h-12 px-4 border-b border-zinc-800/60 bg-[#09090b]/80 backdrop-blur-md flex items-center justify-between gap-3 z-10">
        ...
        {/* Signature Floating Input Pill Capsule (Matching Reference Screenshots) */}
        <div className="p-3 sm:p-4 bg-[#09090b]/90 backdrop-blur-xl border-t border-zinc-800/80">
